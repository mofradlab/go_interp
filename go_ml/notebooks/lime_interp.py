...
bert_attr = bert_attr[enzyme_mask.shape[0]] - 1e9*(~enzyme_mask)
...
for i, r in enumerate(enzyme_iterator()):
    mut_seq_batch = mut_batch(r['prot_id'], r['seq'], top_k_ind[i, :min(75, len(r['seq']))], lambda_=15, batch_size=20000)
...
with open('/home/andrew/GO_interp/data/enzyme_mut_20000_evals.pkl', 'wb') as f:
